<div class="min-h-screen bg-gray-100 flex flex-col p-6 w-full">
    <!-- 🔍 Recherche -->
    <div class="mb-4">
        <input type="text" wire:model.live="search" placeholder="🔍 Rechercher un(e) professionnel(le)..."
    ...
    <div class="flex flex-col lg:flex-row space-y-4 lg:space-y-0 lg:space-x-4">
        ...
        <div class="lg:w-2/3 w-full bg-white shadow-md rounded-lg p-4 flex flex-col">
            ...
            @else
                <p class="text-gray-500 text-center">Sélectionnez un(e) professionnel(le) pour démarrer une conversation.</p>
            @endif
        </div>
    </div>
