...
<div class="container">
    ...
    <div class="header">
        ...
        <h1>📩 Invitation à rejoindre la clinique {{$clinicName}}</h1>
    </div>

    <!-- Contenu -->
    <div class="content">
        <p>👋 Bonjour <strong>{{ $user->name }}</strong>,</p>
        <p>Vous avez été invité à rejoindre la clinique <strong>{{$clinicName}}</strong></p>
        <!-- Message de l'utilisateur -->
        <div class="info">
            <p>Pour rejoindre la clinique, </p>
